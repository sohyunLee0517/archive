...
export default function PrintDocument({ rootId }: { rootId?: string }) {
  return (
    <div
      id={rootId}
    ...
    >
      <header className="break-inside-avoid border-b border-primary pb-5">
        <div
          className="mb-2 text-[11px] uppercase tracking-[0.08em] text-secondary"
          style={{ fontFamily: "var(--font-terminal)" }}
        >
          <span className="text-primary">$</span> cat /sys/archive/print-all.md
        </div>
        <h1
      ...
      <section className="pdf-page-break pdf-page-block break-inside-avoid">
        ...
        />
        <div className="border border-outline-variant bg-white p-8">
          <dl className="space-y-3" style={{ fontFamily: "var(--font-terminal)" }}>
